...
; Orange people
	...
	const EVENT_BEAUTIFUL_BEACH_VILLA_DARACH
	const EVENT_BEAUTIFUL_BEACH_VILLA_CAITLIN
...
; New to Crystal
	...
	const EVENT_UNKI_UNSEALED
	const EVENT_UNKI_CHAMBER_UNLOCKED
	const EVENT_UNOWN_KING
	const EVENT_RUINS_OF_ALPH_EXTRA_EVENT
