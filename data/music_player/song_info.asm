...
SongInfo:
	...
	song_info "Credits (KSS Mix)", ORIGIN_GS, COMPOSER_GO_ICHINOSE_JUN_ISHIKAWA, COMPOSER_OXYGENTHESMOLANGEL
	...
	song_info "Waterfall", ORIGIN_UNDERTALE, COMPOSER_TOBY_FOX, COMPOSER_OXYGENTHESMOLANGEL
	song_info "Story of Undertale   (Bad Romance)", ORIGIN_YOUTUBE, COMPOSER_LADY_GAGA_LHUGUENY, COMPOSER_OXYGENTHESMOLANGEL
	song_info "House-like Carpet", ORIGIN_BLUESKY, COMPOSER_TOBY_FOX, COMPOSER_OXYGENTHESMOLANGEL
	song_info "Faint Courage", ORIGIN_DELTARUNE, COMPOSER_TOBY_FOX, COMPOSER_OXYGENTHESMOLANGEL
	song_info "Black Knife", ORIGIN_DELTARUNE, COMPOSER_TOBY_FOX, COMPOSER_OXYGENTHESMOLANGEL
	song_info "Vs. Zero Two", ORIGIN_KIRBY64, COMPOSER_JUN_ISHIKAWA, COMPOSER_OXYGENTHESMOLANGEL
	song_info "A Thousand Leagues   Below", ORIGIN_SKNIGHT, COMPOSER_MANAMI_MATSUMAE, COMPOSER_OXYGENTHESMOLANGEL
	song_info  "Monochrome", ORIGIN_LULLABY, COMPOSER_ADAM_MCHUMMUS, COMPOSER_OXYGENTHESMOLANGEL
