...
BugsyGroup:
	...
	def_trainer 1, "Bugsy"
	tr_mon 14, BUTTERFREE @ WISE_GLASSES, MALE
		tr_evs 32 SAt, 32 Spe
		tr_moves TACKLE, POISONPOWDER, SLEEP_POWDER, CONFUSION
	tr_mon 15, SHUCKLE @ SITRUS_BERRY, MALE
		tr_evs 32 Def, 32 SDf
		tr_moves WRAP, STRING_SHOT, DEFENSE_CURL, REST
	tr_mon 14, YANMA, FEMALE
		tr_evs 64 Atk
		tr_moves FORESIGHT, QUICK_ATTACK, DOUBLE_TEAM, SONIC_BOOM
	tr_mon 17, SCYTHER @ EVIOLITE, FEMALE
		tr_evs 64 Atk
...
endc
	...
	tr_mon 75, SCIZOR @ LUM_BERRY, FEMALE
		tr_moves SWORDS_DANCE, NIGHT_SLASH, X_SCISSOR, IRON_HEAD
	end_trainer
...
WhitneyGroup:
	...
	tr_mon 19, CHANSEY, FEMALE
		tr_evs 64 HP, 32 Def
		tr_moves SUBSTITUTE, FRESH_SNACK, BODY_SLAM, ROLLOUT
	...
	tr_mon 72, BLISSEY @ LEFTOVERS, FEMALE
		tr_moves SUBSTITUTE, SING, FRESH_SNACK, ROLLOUT
...
if DEF(FAITHFUL)
	...
	tr_mon 24, NOCTOWL @ SPELL_TAG, MALE
		tr_evs 64 HP, 64 Spe
		tr_moves HYPNOSIS, FORESIGHT, CONFUSION, HEX
endc
	tr_mon 25, MISDREAVUS @ EVIOLITE, MALE
		tr_evs 64 SAt, 64 Spe
...
ChuckGroup:
	...
	def_trainer 1, "Chuck"
	tr_mon 30, PRIMEAPE @ MUSCLE_BAND, MALE
		tr_extra DEFIANT
		tr_evs 160 Atk
		tr_moves KARATE_CHOP, SEISMIC_TOSS, SCREECH, DYNAMICPUNCH
	tr_mon 28, TYROGUE @ MUSCLE_BAND, MALE
		tr_extra GUTS
		tr_evs 160 Atk
...
JasmineGroup:
	...
	tr_mon 33, PERRSERKER @ METAL_COAT
		tr_evs 192 Atk
...
endc
	tr_mon 73, PERRSERKER @ METAL_COAT
		tr_dvs 14 All
		tr_moves SWORDS_DANCE, SWAGGER, PURSUIT, IRON_HEAD
...
PryceGroup:
	...
	tr_mon 41, MR__MIME @ KINGS_ROCK | GALARIAN_FORM
		tr_evs 224 SAt
		tr_moves REFLECT, DOUBLE_TEAM, PSYBEAM, ICE_SHARD
	tr_mon 40, DELIBIRD
		tr_evs 224 Spe
		tr_moves HAIL, ROOST, DRILL_PECK, AURORA_BEAM
	...
	tr_mon 74, MR__RIME @ NEVERMELTICE
		tr_moves REFLECT, HYPNOSIS, DAZZLINGLEAM, ICE_BEAM
	...
	tr_mon 73, DELIBIRD @ LEFTOVERS
		tr_moves HAIL, ROOST, DRILL_PECK, BLIZZARD
...
ClairGroup:
	...
	def_trainer 1, "Clair"
	tr_mon 43, GYARADOS @ DRAGON_FANG, FEMALE
...
endc
	...
	tr_mon 46, LAPRAS @ DAMP_ROCK, FEMALE
		tr_evs 4 Sat, 252 HP
		tr_moves RAIN_DANCE, DRAGON_PULSE, THUNDER, SING
...
if DEF(FAITHFUL)
	...
	tr_mon 73, AMPHAROS @ DRAGON_FANG, FEMALE
		tr_moves THUNDER_WAVE, CONFUSE_RAY, THUNDERBOLT, DRAGON_PULSE
endc
	tr_mon 74, LAPRAS @ LEFTOVERS, FEMALE
		tr_moves RAIN_DANCE, OUTRAGE, THUNDER, SING
...
WillGroup:
	...
	tr_mon 49, SLOWKING @ CHESTO_BERRY
		tr_evs 144 HP, 144 SDf
		tr_moves SURF, NASTY_PLOT, REST, PSYCHIC_M
	...
	def_trainer 2, "Will"
	tr_mon 69, WYRDEER @ TWISTEDSPOON
		tr_moves SHADOW_BALL, MEGAHORN, EARTHQUAKE, PSYCHIC_M
	tr_mon 70, JYNX @ BRIGHTPOWDER
		tr_moves NASTY_PLOT, DRAINING_KISS, ICE_BEAM, PSYCHIC_M
	tr_mon 70, EXEGGUTOR @ MIRACLE_SEED
		tr_moves REFLECT, GIGA_DRAIN, SLEEP_POWDER, PSYCHIC_M
	tr_mon 71, ALAKAZAM @ LUM_BERRY
		tr_moves HP_FIGHTING, RECOVER, SHADOW_BALL, PSYCHIC_M
	tr_mon 71, SLOWKING @ CHESTO_BERRY
		tr_moves SURF, PSYCHIC_M, SWAGGER, REST
	tr_mon 72, XATU @ LEFTOVERS
...
BrunoGroup:
	...
	def_trainer 1, "Bruno"
	tr_mon 51, MAGMORTAR @ LIFE_ORB
		tr_evs 176 SAt, 176 Spe
		tr_moves FLAMETHROWER, SUNNY_DAY, SOLAR_BEAM, FOCUS_BLAST
	...
	def_trainer 2, "Bruno"
	tr_mon 71, MAGMORTAR @ HEAT_ROCK
		tr_moves FIRE_BLAST, SUNNY_DAY, SOLAR_BEAM, FOCUS_BLAST
	tr_mon 72, SNEASLER @ SILVERPOWDER
		tr_moves SWORDS_DANCE, X_SCISSOR, CLOSE_COMBAT, GUNK_SHOT
	tr_mon 71, HITMONLEE @ FOCUS_BAND
		tr_moves BULK_UP, SUCKER_PUNCH, HI_JUMP_KICK, REVERSAL
	tr_mon 71, HITMONCHAN @ NEVERMELTICE
		tr_moves THUNDERPUNCH, ICE_PUNCH, POISON_JAB, MACH_PUNCH
	tr_mon 73, STEELIX @ LEFTOVERS
		tr_moves CURSE, EARTHQUAKE, STONE_EDGE, IRON_HEAD
	tr_mon 75, MACHAMP @ MUSCLE_BAND
...
KarenGroup:
	...
	tr_mon 55, GIRAFARIG @ EVIOLITE, FEMALE
		tr_evs 252 SAt, 132 Spe
		tr_moves NASTY_PLOT, BATON_PASS, PSYCHIC_M, DARK_PULSE
	...
	def_trainer 2, "Karen"
	tr_mon 72, UMBREON @ LEFTOVERS
		tr_moves CHARM, HEALINGLIGHT, PURSUIT, TOXIC
	tr_mon 73, WEAVILE @ KINGS_ROCK
		tr_moves SWORDS_DANCE, SCREECH, SLASH, ICE_PUNCH
	tr_mon 75, FARIGIRAF @ ASSAULT_VEST
		tr_moves DOUBLE_KICK, DARK_PULSE, SHADOW_BALL, ZEN_HEADBUTT
	tr_mon 74, HONCHKROW @ BLACKGLASSES
		tr_moves DRILL_PECK, SUCKER_PUNCH, NIGHT_SLASH, BRAVE_BIRD
	tr_mon 75, TYRANITAR @ SOFT_SAND
		tr_moves EARTHQUAKE, CRUNCH, STONE_EDGE, PURSUIT
	tr_mon 77, HOUNDOOM @ WISE_GLASSES
...
ChampionGroup:
	...
	tr_mon 58, EXEGGUTOR @ LUM_BERRY, MALE | ALOLAN_FORM
...
endc
	...
	tr_mon 76, GYARADOS @ LIFE_ORB, MALE
		tr_extra SPE_UP_SATK_DOWN
		tr_moves DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
	tr_mon 78, EXEGGUTOR @ LUM_BERRY, MALE | ALOLAN_FORM
		tr_extra HARVEST, SATK_UP_ATK_DOWN
		tr_moves GIGA_DRAIN, DRAGON_PULSE, FLAMETHROWER, SLUDGE_BOMB
	tr_mon 78, KINGDRA @ CHOICE_SPECS
		tr_extra SATK_UP_ATK_DOWN
		tr_moves HYDRO_PUMP, SCALD, ICE_BEAM, DRAGON_PULSE
	tr_mon 77, AERODACTYL @ CHOICE_BAND, MALE
		tr_extra TOUGH_CLAWS, ATK_UP_SATK_DOWN
		tr_moves STONE_EDGE, BRAVE_BIRD, IRON_HEAD, CRUNCH
	tr_mon 76, CHARIZARD @ LEFTOVERS, MALE
if DEF(FAITHFUL)
...
endc
	...
	def_trainer 2, "Blue"
	tr_mon 84, UMBREON @ BRIGHTPOWDER
		tr_moves CONFUSE_RAY, TOXIC, FEINT_ATTACK, PROTECT
	tr_mon 83, MACHAMP @ BLACK_BELT
		tr_moves CROSS_CHOP, EARTHQUAKE, STONE_EDGE, THUNDERPUNCH
	tr_mon 84, KABUTOPS @ HARD_STONE
		tr_moves SLASH, SURF, STONE_EDGE, GIGA_DRAIN
	tr_mon 84, EXEGGUTOR @ MIRACLE_SEED
		tr_moves PSYCHIC_M, LEECH_SEED, SEED_BOMB, GIGA_DRAIN
	tr_mon 84, ARCANINE @ CHARCOAL
...
LeafGroup:
	...
	def_trainer 1, "Oxygen"
	tr_mon 94, "Drone", MAGNEZONE @ FOCUS_SASH, MALE
		tr_extra LEVITATE, SATK_UP_ATK_DOWN
		tr_moves FLASH_CANNON, THUNDER_WAVE, LIGHT_SCREEN, THUNDERBOLT
    tr_mon 97, "Nicole",SNEASLER @ SCOPE_LENS, FEMALE
		tr_extra POISON_TOUCH, ATK_UP_SATK_DOWN
		tr_moves GUNK_SHOT, KNOCK_OFF, CLOSE_COMBAT, SWORDS_DANCE
    tr_mon 96, "Sea", KINGDRA @ LANSAT_BERRY, MALE
		tr_extra SNIPER, SPE_UP_ATK_DOWN, SHINY
		tr_moves DRAGON_PULSE, FOCUS_ENERGY, TOXIC, SURF
    tr_mon 90, "Free", BUTTERFREE @ SILVERPOWDER, FEMALE
		tr_extra COMPOUND_EYES, SPE_UP_ATK_DOWN
		tr_moves PSYCHIC_M, AIR_SLASH, BUG_BUZZ, SLEEP_POWDER
    tr_mon 96, "Kyubi", NINETALES @ HEAT_ROCK, FEMALE
		tr_extra DROUGHT, SATK_UP_ATK_DOWN
		tr_moves FLAMETHROWER, BATON_PASS, SHADOW_BALL, NASTY_PLOT
    tr_mon 100, "Unki", UNOWN_KING @ BERSERK_GENE, MALE
		tr_extra BATTLE_ARMOR, SDEF_UP_SATK_DOWN
		tr_moves BULLET_PUNCH, ZEN_HEADBUTT, BELLY_DRUM, BERSERKCHOMP
	end_trainer
...
Rival2Group:
	...
	tr_mon 66, ALAKAZAM @ BRIGHTPOWDER
		tr_evs 252 SAt, 204 Spe
		tr_moves DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	tr_mon 68, FERALIGATR @ MYSTIC_WATER
		tr_evs 204 Atk, 252 Spe
		tr_moves WATERFALL, CRUNCH, SLASH, SCARY_FACE
	end_trainer

	def_trainer 4, "<RIVAL>"
	tr_mon 71, WEAVILE @ KINGS_ROCK
		tr_moves SWORDS_DANCE, ICE_PUNCH, SLASH, CRUNCH
	tr_mon 72, CROBAT @ POISON_BARB
		tr_moves POISON_JAB, CRUNCH, CONFUSE_RAY, TOXIC
	tr_mon 71, MAGNEZONE @ MAGNET
		tr_moves THUNDERBOLT, TRI_ATTACK, THUNDER_WAVE, FLASH_CANNON
	tr_mon 73, GENGAR @ SPELL_TAG
		tr_moves THUNDERBOLT, FOCUS_BLAST, SHADOW_BALL, CONFUSE_RAY
	tr_mon 73, ALAKAZAM @ BRIGHTPOWDER
	...
	tr_mon 73, ALAKAZAM @ BRIGHTPOWDER
		tr_moves RECOVER, TRI_ATTACK, PSYCHIC_M, REFLECT
	tr_mon 75, FERALIGATR @ LEFTOVERS
...
Lyra2Group:
	...
	tr_mon 74, AMPHAROS
	tr_mon 71, FARIGIRAF
	tr_mon 75, "Chicory", MEGANIUM @ SITRUS_BERRY
	end_trainer
	...
	tr_mon 74, AMPHAROS
	tr_mon 71, FARIGIRAF
	tr_mon 75, "Cinder", TYPHLOSION @ SITRUS_BERRY
	end_trainer
	...
	tr_mon 74, AMPHAROS
	tr_mon 71, FARIGIRAF
	tr_mon 75, "Toto", FERALIGATR @ SITRUS_BERRY
	end_trainer
...
YoungsterGroup:
	...
	tr_mon 100, RATICATE @ SITRUS_BERRY, MALE
		tr_extra GUTS, ATK_UP_SATK_DOWN
		tr_dvs 15 All
...
FisherGroup:
	...
	tr_mon 30, MAGIKARP, MALE | MAGIKARP_CALICO2_FORM
		tr_moves STRUGGLE, TACKLE, REVERSAL, DRAGON_RAGE
...
GuitaristFGroup:
	...
	tr_mon 60, PIKACHU, FEMALE | PIKACHU_SURF_FORM
		tr_moves IRON_TAIL, EXTREMESPEED, SURF, THUNDERBOLT
	tr_mon 58, ELECTABUZZ, FEMALE
		tr_moves LIGHT_SCREEN, THUNDERPUNCH, CROSS_CHOP, SCREECH
	tr_mon 59, RAICHU, FEMALE | ALOLAN_FORM
...
AceDuoGroup:
	...
	tr_mon 68, PORYGON2, MALE
	tr_mon 68, AZUMARILL, FEMALE
	end_trainer
	...
	tr_mon 67, TAUROS, MALE
	tr_mon 67, GIRAFARIG, FEMALE
	end_trainer
...
DarachGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 22, NIDOQUEEN
	tr_mon LEVEL_FROM_BADGES + 20, HERACROSS
if DEF(FAITHFUL)
	tr_mon LEVEL_FROM_BADGES + 21, MACHAMP
	tr_mon LEVEL_FROM_BADGES + 20, SKARMORY
else
	tr_mon LEVEL_FROM_BADGES + 21, BLASTOISE
	tr_mon LEVEL_FROM_BADGES + 20, FARFETCH_D
endc
	tr_mon LEVEL_FROM_BADGES + 22, MISMAGIUS
	tr_mon LEVEL_FROM_BADGES + 24, HOUNDOOM
	end_trainer
...
CaitlinGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 22, ESPEON
	tr_mon LEVEL_FROM_BADGES + 20, XATU
	tr_mon LEVEL_FROM_BADGES + 21, STARMIE
	tr_mon LEVEL_FROM_BADGES + 20, JYNX
	tr_mon LEVEL_FROM_BADGES + 22, ALAKAZAM
	tr_mon LEVEL_FROM_BADGES + 24, HYPNO
	end_trainer
...
CandelaGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 27, FLAREON
	tr_mon LEVEL_FROM_BADGES + 26, MAGMAR
	tr_mon LEVEL_FROM_BADGES + 27, CHARIZARD
	tr_mon LEVEL_FROM_BADGES + 25, DRAGONITE
	tr_mon LEVEL_FROM_BADGES + 26, ARCANINE
	tr_mon LEVEL_FROM_BADGES + 29, MOLTRES @ CHARCOAL
	end_trainer
...
BlancheGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 27, VAPOREON
	tr_mon LEVEL_FROM_BADGES + 26, LAPRAS
	tr_mon LEVEL_FROM_BADGES + 27, BLASTOISE
	tr_mon LEVEL_FROM_BADGES + 25, JYNX
	tr_mon LEVEL_FROM_BADGES + 26, STARMIE
	tr_mon LEVEL_FROM_BADGES + 29, ARTICUNO @ NEVERMELTICE
	end_trainer
...
SparkGroup:
	...
	def_trainer 1, "Spark"
	tr_mon LEVEL_FROM_BADGES + 27, JOLTEON, MALE
	tr_mon LEVEL_FROM_BADGES + 26, ELECTABUZZ, MALE
	tr_mon LEVEL_FROM_BADGES + 27, VENUSAUR, MALE
	tr_mon LEVEL_FROM_BADGES + 25, SNORLAX, MALE
	tr_mon LEVEL_FROM_BADGES + 28, PIKACHU @ LIGHT_BALL, MALE | PIKACHU_SPARK_FORM
	tr_mon LEVEL_FROM_BADGES + 29, ZAPDOS @ MAGNET, MALE
	end_trainer
...
SECTION "GoldGroup", ROMX
GoldGroup:

	def_trainer_class GOLD
	def_trainer 1, "Gold"
	tr_mon 5, "HURRY", CYNDAQUIL @ QUICK_CLAW, FEMALE
		tr_moves FLASH, LEER
	...
	tr_mon 85, "NOMORE", UNOWN @ CHOICE_SPECS, MALE | UNOWN_N_FORM
	    tr_extra SHINY
		tr_moves HIDDEN_POWER
	tr_mon 100, CELEBI @ SITRUS_BERRY, MALE | CELEBI_LOST_FORM
	    tr_extra SHINY
		tr_moves FUTURE_SIGHT, PERISH_SONG, PAIN_SPLIT
	end_trainer
