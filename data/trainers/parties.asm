...
SECTION "OxygenGroup", ROMX
OxygenGroup:

	; OXYGEN
	db "Oxygen@"
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES | TRAINERTYPE_NICKNAME
	; party
	dbp 85, SNEASLER, FEMALE
		db "Nicole@"
		db FOCUS_SASH, ABILITY_1 | NAT_SPE_UP_SATK_DOWN
		db SWORDS_DANCE, POISON_JAB, QUICK_ATTACK, LOW_KICK
	dbp 87, MAGNEZONE
		db "Drone@"
		db LUM_BERRY, ABILITY_2 | NAT_SATK_UP_ATK_DOWN
		db LIGHT_SCREEN, FLASH_CANNON, THUNDERBOLT, THUNDER_WAVE
	dbp 87, NINETALES, MALE
		db "Kyubi@"
		db DESTINY_KNOT, ABIL_NINETALES_DROUGHT | NAT_SATK_UP_ATK_DOWN
		db FLAMETHROWER, HYPNOSIS, SHADOW_BALL, NASTY_PLOT
	dbp 86, URSALUNA, MALE | URSALUNA_BLOODMOON_FORM
		db "Freddy@"
		db LEFTOVERS, ABILITY_1 | NAT_ATK_UP_SATK_DOWN
		db SCARY_FACE, BELLY_DRUM, REST, CRUNCH
	dbp 85, WEAVILE, MALE
		db "Sneeze@"
		db RAZOR_CLAW, ABILITY_1 | NAT_ATK_UP_SATK_DOWN
		db ICE_SHARD, HONE_CLAWS, X_SCISSOR, FEINT_ATTACK
	dbp 90, UNOWN_KING, MALE
		db "Unki@"
		db BERSERK_GENE, ABIL_UNOWNKING_BATTLE_ARMOR | NAT_ATK_UP_SATK_DOWN
		db BERSERKCHOMP, GLARE, BULLET_PUNCH, ZEN_HEADBUTT
	db -1 ; end
...
<<<<<<< HEAD
	...
	dbp 30, MAGIKARP, MALE | MAGIKARP_CALICO2_FORM
		...
		db STRUGGLE, TACKLE, REVERSAL, DRAGON_RAGE
